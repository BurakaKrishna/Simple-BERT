...
num_evaluations = 10  # Number of evaluations to make per epoch
training = True
testing = True
...
with tf.Session() as sess:
    ...
    if training:
        ...
        for epoch in range(1, num_epochs + 1):
            ...
            for train_step in range(1, num_training_steps + 1):
                ...
                if train_step % (math.floor(round(num_training_steps / num_evaluations) / 100) * 100) == 0:
    ...
    if testing:
        ...
        for test_step in range(1, num_test_steps + 1):
            test_batch_loss, test_batch_logits, test_batch_accuracy = \
                sess.run([loss, logits, accuracy], feed_dict={handle_pl: test_handle})
